...
### Derived from: KPW Tier 4 template system
...
3. **How [Owner] Works** `section.section` (bg-subtle) — `.areas-grid`: 3 `.area-card` (value props)
...
<article class="service-card blog-card">
  ...
  <div class="card-body">
    ...
    <a href="[blog.clientdomain.com post URL]" class="btn btn-outline" target="_blank" rel="noopener">Read More &rarr;</a>
  </div>
</article>
```
...
<p class="blog-callout">&#128196; <strong>From the Blog:</strong>
  <a href="[blog.clientdomain.com post URL]" target="_blank" rel="noopener">[Post Title]</a>
